#
#  Be sure to run `pod spec lint HTTPCookieMessageHandler.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "HTTPCookieMessageHandler"
  s.version      = "0.1.0"
  s.summary      = "A JSON parser and storage handler for HTTPCookies."
